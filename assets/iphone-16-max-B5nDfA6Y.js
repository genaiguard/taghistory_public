import{d as u,l as f,a as d,e as _,b as h}from"./TileLayer-Dpdh0QDv.js";import{r as C}from"./main-DL-qfKNq.js";function g(o,e,i){e.center!==i.center&&o.setLatLng(e.center),e.radius!=null&&e.radius!==i.radius&&o.setRadius(e.radius)}const B=u(function({center:e,children:i,...t},r){const a=new f.Circle(e,t);return d(a,_(r,{overlayContainer:a}))},g),m=u(function({positions:e,...i},t){const r=new f.Polyline(e,i);return d(r,_(t,{overlayContainer:r}))},function(e,i,t){i.positions!==t.positions&&e.setLatLngs(i.positions)}),V=h(function(e,i){const t=new f.Tooltip(e,i.overlayContainer);return d(t,i)},function(e,i,{position:t},r){C.useEffect(function(){const l=i.overlayContainer;if(l==null)return;const{instance:n}=e,p=s=>{s.tooltip===n&&(t!=null&&n.setLatLng(t),n.update(),r(!0))},c=s=>{s.tooltip===n&&r(!1)};return l.on({tooltipopen:p,tooltipclose:c}),l.bindTooltip(n),function(){l.off({tooltipopen:p,tooltipclose:c}),l._map!=null&&l.unbindTooltip()}},[e,i,r,t])});(()=>{var o=`
<div class="container">
...
`,e=typeof window<"u"&&window?.HTMLElement,i=class extends e{constructor(){super();let t=document.createElement("style");t.innerHTML=`
      :host {
    ...
    `;let r=this.attachShadow({mode:"open"});this.getAttribute("nonce")&&t.setAttribute("nonce",this.getAttribute("nonce"));let a=this.getAttribute("mode")??"light",l=o;a==="dark"&&(l=l.replace(/#0D0D0E/g,"#ffffff")),r.appendChild(t),r.innerHTML=r.innerHTML+l}connectedCallback(){new ResizeObserver(this.resetWidth.bind(this)).observe(this),this.resetWidth(),this.setAttribute("rendered","")}resetWidth(){this.style.setProperty("--width",`${this.clientWidth}px`)}};typeof window<"u"&&!window.customElements.get("iphone-16-max")&&window.customElements.define("iphone-16-max",i)})();export{B as C,m as P,V as T,g as u};
