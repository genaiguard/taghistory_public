import{g as O,d as A,_ as P,z as I,i as _,p as D,u as R,F as L,w as x,C as F,x as E,e as U,a as $}from"./firebaseApp-B0hKjVmG.js";/**
 * @license
...
`);i=p.pop()||"";for(const l of p)l.trim()&&s(l.trim(),a);return u()}catch(d){const c=d instanceof f?d:k(0,null);a.error(c),n(c)}}},cancel(){return e.cancel()}})}const b="@firebase/functions",C="0.13.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function se(e=O(),t=y){const r=P(A(e),w).getImmediate({identifier:t}),s=I("functions");return s&&oe(r,...s),r}function oe(e,t,n){B(A(e),t,n)}function ie(e,t,n){return X(A(e),t,n)}re();const ae=se($),ue=Object.freeze(Object.defineProperty({__proto__:null,functions:ae,httpsCallable:ie},Symbol.toStringTag,{value:"Module"}));export{ue as a,ae as f,se as g,ie as h};
