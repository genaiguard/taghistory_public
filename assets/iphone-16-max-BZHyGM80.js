import{d as _,l as p,a as c,e as u,b as h}from"./TileLayer-j_JJQDIt.js";import{r as C}from"./main-BB87ROjx.js";const x=_(function({positions:t,...i},e){const r=new p.Polyline(t,i);return c(r,u(e,{overlayContainer:r}))},function(t,i,e){i.positions!==e.positions&&t.setLatLngs(i.positions)}),B=h(function(t,i){const e=new p.Tooltip(t,i.overlayContainer);return c(e,i)},function(t,i,{position:e},r){C.useEffect(function(){const l=i.overlayContainer;if(l==null)return;const{instance:a}=t,f=n=>{n.tooltip===a&&(e!=null&&a.setLatLng(e),a.update(),r(!0))},d=n=>{n.tooltip===a&&r(!1)};return l.on({tooltipopen:f,tooltipclose:d}),l.bindTooltip(a),function(){l.off({tooltipopen:f,tooltipclose:d}),l._map!=null&&l.unbindTooltip()}},[t,i,r,e])});(()=>{var o=`
<div class="container">
...
`,t=typeof window<"u"&&window?.HTMLElement,i=class extends t{constructor(){super();let e=document.createElement("style");e.innerHTML=`
      :host {
    ...
    `;let r=this.attachShadow({mode:"open"});this.getAttribute("nonce")&&e.setAttribute("nonce",this.getAttribute("nonce"));let s=this.getAttribute("mode")??"light",l=o;s==="dark"&&(l=l.replace(/#0D0D0E/g,"#ffffff")),r.appendChild(e),r.innerHTML=r.innerHTML+l}connectedCallback(){new ResizeObserver(this.resetWidth.bind(this)).observe(this),this.resetWidth(),this.setAttribute("rendered","")}resetWidth(){this.style.setProperty("--width",`${this.clientWidth}px`)}};typeof window<"u"&&!window.customElements.get("iphone-16-max")&&window.customElements.define("iphone-16-max",i)})();export{x as P,B as T};
