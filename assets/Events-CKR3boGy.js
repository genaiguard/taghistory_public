...
}`})}),e.jsxs("p",{className:"text-sm",children:[e.jsx("strong",{children:"lastSeenAt:"})," ISO 8601 timestamp of the last location report.",e.jsx("br",{}),e.jsx("strong",{children:"staleSeconds:"})," Seconds elapsed since the last location was seen."]})]})]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsx("h2",{className:"text-2xl font-bold",children:"When Events Are Not Emitted"}),e.jsxs("p",{className:"text-sm",children:["While a tag's recording is paused (",e.jsx("code",{className:"bg-muted px-2 py-1 rounded",children:"recordingPaused: true"}),"), no ",e.jsx("code",{className:"bg-muted px-2 py-1 rounded",children:"tag.*"})," events are emitted for that tag — location updates, battery checks, and offline detection are all suspended until recording resumes. See ",e.jsx(s,{to:"/docs/concepts/locations",className:"font-semibold text-primary hover:underline",children:"Recording Pause"})," for details."]})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsx("h2",{className:"text-2xl font-bold",children:"Reserved Events"}),e.jsx("p",{children:"Reserved for a future API version. These event types are accepted on subscriptions for forward-compatibility but are NOT emitted in v1:"}),e.jsxs("ul",{className:"space-y-2 list-disc list-inside text-sm",children:[e.jsxs("li",{children:[e.jsx("strong",{children:"geofence.entry"})," — A tag entered a geofence."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"geofence.exit"})," — A tag left a geofence."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"geofence.dwell"})," — A tag has been inside a geofence for a set duration."]})]}),e.jsx("p",{className:"text-sm",children:"Geofence alerts are currently sent via email through the geofence's own alert settings, which you configure in your dashboard. You can include these event types on a subscription now for forward-compatibility, but they are not emitted in v1."})]}),e.jsxs("section",{className:"space-y-4",children:[e.jsx("h2",{className:"text-2xl font-bold",children:"See Also"}),e.jsxs("ul",{className:"space-y-2 list-disc list-inside text-sm",children:[e.jsx("li",{children:e.jsx(s,{to:"/docs/webhooks/delivery",className:"font-semibold text-primary hover:underline",children:"Delivery format and signature verification"})}),e.jsx("li",{children:e.jsx(s,{to:"/docs/webhooks/testing",className:"font-semibold text-primary hover:underline",children:"Testing webhooks"})}),e.jsx("li",{children:e.jsx(s,{to:"/docs/guides/webhooks-setup",className:"font-semibold text-primary hover:underline",children:"Webhooks setup guide"})})]})]})]})}export{c as default};
