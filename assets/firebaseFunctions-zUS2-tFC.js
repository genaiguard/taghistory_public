import{g as O,c as A,_ as P,y as I,i as _,p as D,u as R,F as L,v as F,C as x,w as E,d as U}from"./index.esm-BVUixzL4.js";import{a as $}from"./firebaseApp-CaY_PwV6.js";/**
 * @license
 ...
 */const M="type.googleapis.com/google.protobuf.Int64Value",j="type.googleapis.com/google.protobuf.UInt64Value";function C(e,t){const n={};for(const r in e)e.hasOwnProperty(r)&&(n[r]=t(e[r]));return n}function y(e){if(e==null)return null;if(e instanceof Number&&(e=e.valueOf()),typeof e=="number"&&isFinite(e)||e===!0||e===!1||Object.prototype.toString.call(e)==="[object String]")return e;if(e instanceof Date)return e.toISOString();if(Array.isArray(e))return e.map(t=>y(t));if(typeof e=="function"||typeof e=="object")return C(e,t=>y(t));throw new Error("Data cannot be encoded in JSON: "+e)}function m(e){if(e==null)return e;if(e["@type"])switch(e["@type"]){case M:case j:{const t=Number(e.value);if(isNaN(t))throw new Error("Data cannot be decoded from JSON: "+e);return t}default:throw new Error("Data cannot be decoded from JSON: "+e)}return Array.isArray(e)?e.map(t=>m(t)):typeof e=="function"||typeof e=="object"?C(e,t=>m(t)):e}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ee="auth-internal",te="app-check-internal",ne="messaging-internal";function re(e){const t=(n,{instanceIdentifier:r})=>{const s=n.getProvider("app").getImmediate(),o=n.getProvider(ee),a=n.getProvider(ne),i=n.getProvider(te);return new V(s,o,a,i,r)};F(new x(w,t,"PUBLIC").setMultipleInstances(!0)),E(b,v,e),E(b,v,"esm2020")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
