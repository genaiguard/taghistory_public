import{j as e,L as s}from"./main-Bm6hmgm5.js";import{D as t}from"./DocPageTemplate-DV1DzLop.js";import"./x-CWLESPuC.js";import"./chevron-right-CLxNJPGk.js";import"./button-begoqf8C.js";import"./index-CHGHLV8X.js";import"./index-gc1ARzsb.js";function d(){return e.jsxs(t,{title:"Batch Operations and Pagination",description:"Efficiently work with multiple tags and handle large result sets",children:[e.jsxs("section",{className:"space-y-4",children:[e.jsx("h2",{className:"text-2xl font-bold",children:"Listing All Tags"}),e.jsxs("p",{children:["To fetch all your tags in one call, use the ",e.jsx(s,{to:"/docs/api-reference/endpoints",className:"font-semibold text-primary hover:underline",children:"GET /v1/tags endpoint"}),":"]}),e.jsx("div",{className:"rounded-lg border border-border bg-muted/30 p-4",children:e.jsx("pre",{className:"overflow-x-auto font-mono text-sm",children:`const response = await fetch('https://api.taglogger.com/v1/tags', {
