import{j as e,L as s}from"./main-D7Z5ZBG4.js";import{D as t}from"./DocPageTemplate-C-AktZ6l.js";import"./x-CoVIIE-q.js";import"./chevron-right-gLQV3I7M.js";import"./button-HXwySMQC.js";import"./index-4B7FssXQ.js";import"./index-DiIOE-D_.js";function d(){return e.jsxs(t,{title:"Batch Operations and Pagination",description:"Efficiently work with multiple tags and handle large result sets",children:[e.jsxs("section",{className:"space-y-4",children:[e.jsx("h2",{className:"text-2xl font-bold",children:"Listing All Tags"}),e.jsxs("p",{children:["To fetch all your tags in one call, use the ",e.jsx(s,{to:"/docs/api-reference/endpoints",className:"font-semibold text-primary hover:underline",children:"GET /v1/tags endpoint"}),":"]}),e.jsx("div",{className:"rounded-lg border border-border bg-muted/30 p-4",children:e.jsx("pre",{className:"overflow-x-auto font-mono text-sm",children:`const response = await fetch('https://api.taglogger.com/v1/tags', {
